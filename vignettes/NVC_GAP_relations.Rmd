...
NVC_text <- paste(unit_text$translatedName,
                  unit_text$typeConcept,
                  unit_text$Physiognomy,
                  unit_text$Environment,
                  unit_text$Dynamics,
                  unit_text$Floristics,
                  unit_text$Range)

txt_nchar <- lapply(NVC_text, FUN = function(x) nchar(conv_txt(x)))
